...
RSpec.describe 'Items API' do
  ...
  let!(:entry) { create(:entry, created_by: user.id) }
  ...
  describe 'GET /entries/:entry_id/items' do
    before { get "/entries/#{entry_id}/items", params: {}, headers: headers }
  ...
  describe 'GET /entries/:entry_id/items/:id' do
    before { get "/entries/#{entry_id}/items/#{id}", params: {}, headers: headers }
  ...
  describe 'POST /entries/:entry_id/items' do
    let(:valid_attributes) { { name: 'Visit Narnia', visible: false }.to_json }

    context 'when request attributes are valid' do
      before do
        post "/entries/#{entry_id}/items", params: valid_attributes, headers: headers
      end
    ...
    context 'when an invalid request' do
      before { post "/entries/#{entry_id}/items", params: {}, headers: headers }
  ...
  describe 'PUT /entries/:entry_id/items/:id' do
    ...
    before do
      put "/entries/#{entry_id}/items/#{id}", params: valid_attributes, headers: headers
    end
  ...
  describe 'DELETE /entries/:id' do
    before { delete "/entries/#{entry_id}/items/#{id}", params: {}, headers: headers }
